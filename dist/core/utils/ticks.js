System.register(['../time_series2'], function(exports_1) {
  var time_series2_1;
  /**
   * Calculate tick step.
  ...
  exports_1('getScaledDecimals', getScaledDecimals);
  /**
  ...
  exports_1('getFlotTickSize', getFlotTickSize);
  /**
  ...
  exports_1('getFlotRange', getFlotRange);
  /**
  ...
  exports_1('getFlotTickDecimals', getFlotTickDecimals);
  /**
  ...
  exports_1('grafanaTimeFormat', grafanaTimeFormat);
  /**
  ...
  exports_1('getPrecision', getPrecision);
  /**
  ...
  exports_1('getStringPrecision', getStringPrecision);
  return {
    setters: [
