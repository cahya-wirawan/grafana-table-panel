System.register(['app/core/utils/kbn', './utils/ticks', 'lodash'], function(exports_1) {
  var kbn_1, ticks_1, lodash_1;
  var TimeSeries;
  ...
  exports_1('updateLegendValues', updateLegendValues);
  ...
  exports_1('getDataMinMax', getDataMinMax);
  return {
    setters: [
      function(kbn_1_1) {
        kbn_1 = kbn_1_1;
    ...
    execute: function() {
      TimeSeries = (function() {
        ...
        TimeSeries.prototype.updateLegendValues = function(
          formater,
          decimals,
          scaledDecimals
        ) {
